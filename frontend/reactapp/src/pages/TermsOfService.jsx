      ...
      <div className="max-w-3xl w-full">
        ...
        <div className="space-y-8 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>
              By accessing or using <strong>SQLTogether</strong> ("the Service"), you agree to be bound by these Terms of Service. If you disagree with any part of the terms, you may not access the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              SQLTogether is a web-based collaborative learning environment that allows users to write, discuss, and share SQL work in real time. The Service is provided primarily for educational, demonstration, and portfolio purposes.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-gray-400">
              <li>Upload or execute malicious queries, scripts, viruses, worms, or malware.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-gray-400">
              <li>
                <strong>Your Content:</strong> You retain all rights and ownership of the queries and content you create or upload to SQLTogether.
              </li>
              <li>
                <strong>Our Platform:</strong> The SQLTogether platform, including its interface, logo, and source code, remains the property of the SQLTogether contributors. Original PyTogether attribution and MIT license notices are preserved separately.
              </li>
            </ul>
          </section>
          ...
          <section className="bg-gray-900/50 p-6 rounded-xl border border-gray-800">
            ...
            <p className="text-gray-400">
              SQLTogether makes no representations or warranties of any kind, express or implied, regarding the operation of the Service. We do not guarantee that the Service will function uninterrupted, be secure, or be available at any particular time. <strong>We are not responsible for any loss of queries or data. Please back up your work locally.</strong>
            </p>
          </section>
